...
<div class="about-page">
  ...
  <main class="about-main">
    ...
    <div class="breadcrumb">Home › Centre and Division of NCDC › Integrated Disease Surveillance Programme (IDSP) </div><BR><BR>
    <h1>Integrated Disease Surveillance Programme (IDSP)</h1>
...
WHERE status = 1
  AND division = 'Integrated Disease Surveillance Programme (IDSP)'
