...
<div class="about-page">
  ...
  <main class="about-main">
    ...
    <div class="breadcrumb">Home › Centre and Division of NCDC › Centre for Arboviral and Zoonotic Diseases </div><BR><BR>
    <h1>Centre for Arboviral and Zoonotic Diseases</h1>
...
WHERE status = 1
  AND division = 'Centre for Arboviral and Zoonotic Diseases'
