...
<div class="about-page">
  ...
  <main class="about-main">
    ...
    <div class="breadcrumb">Home › Centre and Division of NCDC › Department of Parasitic Disease </div><BR><BR>
    <h1>Department of Parasitic Disease</h1>
...
WHERE status = 1
  AND division = 'Department of Parasitic Disease'
